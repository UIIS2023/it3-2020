...
public class DlgAdd extends JDialog {
	...
	protected JTextField txtX; // nisu get i set vec protected
	protected JTextField txtY;
	protected JTextField txtWidth;
	protected JTextField txtHeight;
	protected boolean isOk; // proverava koja je vrednost ok promenljive
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
  			...
  			/* try {
							if (txtX.getText().trim().isEmpty() || txtY.getText().trim().isEmpty()
								...
								JOptionPane.showMessageDialog(null, "Height and width can not be negative numbers");
							} else {
								isOk = true;
								setVisible(false);
							}
